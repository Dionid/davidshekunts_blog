 ...
 **В случае с WordPress** у вас есть варианты:
 ...
 (1) Скачать тему и начать всталять в каждм css `!important` и править полурабочий js код.
  Но верстка будет лететь по швам и вы никогда не будете до конца уверены, что ваш сайт отображается так, как вам этого хочется.
 
 (2) Начать пилить тему самому, но для этого придется использовать PHP, CSS и HTML и рендеринг шаблонов на сервере.
 
 Ваши разработчики full-stack гуру JS, а значит в разработке они не более 2-х лет (кто выдержит это дерьмо дольше?) и в
 жизни не видели "голый" HTML и CSS.
 
 Фрилансеров, которые будут разрабатывать тему, брать не хочется, потому что все знают: WordPress фрилансеры – самый подлый
 народ, сравнимо с гоблинами. Не было не единого случая, когда они не обманывали своего наниматели и не сбегали с золотом.
 
 И тут на вашу тусовку **влетает SSG**!
 
 SSG (Gatsby.js, VuePress, Nuxt.js, [etc.](https://www.staticgen.com/) позволяют писать клиентскую часть на современных
 Frontend экосистеме, например, React или Vue.js. В крайнем случае шаблонизаторы типа Pug, ..., А значит можно забыть о
 голом HTML и писать на удобных современному разработчкику инструментах.
